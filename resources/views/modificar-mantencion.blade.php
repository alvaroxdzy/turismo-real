	...
	<div class="row mb-3">
		<div class="col-xl-12"> 
			...
			<div class="mb-3 col-md-2">
				...
				<input value="{{$mantencion->codigo_mantencion}}" style="width:200px" style="text-transform:uppercase" type="text" class="form-control" id="codigo_mantencion" name="codigo_mantencion" minlength="1" maxlength="20" required onkeyup="javascript:this.value=this.value.toUpperCase();" readonly>
